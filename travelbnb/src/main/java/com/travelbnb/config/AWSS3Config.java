...
public class AWSS3Config {
    ...
    /* This configuration allows your Spring Boot application to connect securely to an S3 bucket,
       using the credentials and region specified in your properties file.*/
    @Bean

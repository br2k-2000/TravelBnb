...
public class PropertyController {
    ...
    public ResponseEntity<PropertyDto> addProperty(@RequestParam long locationId,
        ...
        PropertyDto savedProperty = propertyService.addProperty(locationId, countryId, propertyDto);
    ...
    public ResponseEntity<PropertyDto> updateProperty(@PathVariable long propertyId,
        ...
        PropertyDto updatedPropertyDto = propertyService.updateProperty(propertyId, locationId, countryId, propertyDto);
